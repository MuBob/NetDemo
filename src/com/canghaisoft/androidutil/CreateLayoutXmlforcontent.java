...
public class CreateLayoutXmlforcontent extends BaseClass{
	...
	public CreateLayoutXmlforcontent(String name,Class targetClass){
		this(name);
		this.targetClass = targetClass;
	}
	public CreateLayoutXmlforcontent(String name){
	...
	public static void createOne(String name,Class entityClass) throws Exception{
		CreateLayoutXmlforcontent createLayoutXml = new CreateLayoutXmlforcontent(name);
