...
//	public static String srcmycompanyString = "\\src\\com\\mycompany";
	public static String ProgrammePath = "E:\\android\\workspace\\ZoneTryMain\\app\\src\\main";//锟斤拷目锟斤拷锟侥柯�
	...
	public static final String BeanPath = getProgrammePath() + getSrcmycompanyString() + "\\bean";//目录
	...
	public static final String ListRecyclerViewAdapterPath = getProgrammePath() + getSrcmycompanyString() + "\\adapter";
	...
	public static final String DemoBeanPath = getDemoPath() + "\\DemoBean.java";
	public static final String DemoListResponsePath = getDemoPath() + "\\DemoListResponse.java";
	public static final String DemoItemBeanPath = getDemoPath() + "\\DemoItemBean.java";
	...
	public static final String DemoRecyclerViewAdapterPath = getDemoPath() + "\\DemoRecyclerViewAdapter.java";
	...
	public static void setSrcmycompanyString(String srcmycompanyString){
		Create.srcmycompanyString = srcmycompanyString;
	}
