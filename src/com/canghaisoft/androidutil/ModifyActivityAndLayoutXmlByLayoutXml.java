...
public class ModifyActivityAndLayoutXmlByLayoutXml extends BaseClass{
	String idFlag = "android:id=\"@+id/";
	public ModifyActivityAndLayoutXmlByLayoutXml(String name){
		super(name);
	}
	...
	public static void createOne(String name) throws Exception{
		ModifyActivityAndLayoutXmlByLayoutXml modifyActivityAndLayoutXmlByLayoutXml = new ModifyActivityAndLayoutXmlByLayoutXml(name);
		modifyActivityAndLayoutXmlByLayoutXml.execute();
