...
public class CreateEnterpriseServiceAdapter extends BaseTest{
	
	
	public static void main(String[] args) {
		new CreateEnterpriseServiceAdapter().excute();
	}
...
//				super.onResponse(response);
				  ...
				  String newpath= "/EnterpriseServiceRecommendSelectAdapter"
						  ;
				  String itemjson;
//				  try {
//				   itemjson=data.getJSONArray(str).getString(0);
					  
					  itemjson="{               \"goodsID\" : \"1\",               \"snapshotNo\" : \"\",               \"price\" : 555.00,               \"name\" : \"商品名称\"            }";	  itemjson=itemjson.replaceAll("\\s", "");
