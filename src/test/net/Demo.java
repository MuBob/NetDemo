...
map.put(PATH,"/Datadict/Country/List");
...
//map.clear();
//map.put(PATH,"/Reportage/Apply");
//map.put("name","aaaaaaaaaaa");
//map.put("email","yyfdfd@qq.com");
//map.put("mobile","13100000000");
//map.put("projectID",0);
//map.put("desc","1111111111111111111111");
//
//
//request(map, new IResponseListenerSimpleImpl<SimpleResponse>() {
//});
...
map.clear();
map.put(PATH,"/App/Version/Check");
request(map, new IResponseListenerSimpleImpl<SimpleResponse>() {
});
